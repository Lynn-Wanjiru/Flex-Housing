...
const Home = () => {
 ...
 <div>
      ...
      <div className='flex flex-row justify-between p-5 lg:px-32 px-5 bg-gradient-to-r from-backgroundcolor to-brightcolor shadow-md z-10'>
        <div className='flex flex-row items-center cursor-pointer space-x-2'>
          <FcHome size={35} />
          <h1 className='text-xl font-bold'>Flex Nest</h1>
        </div>

        <nav className='hidden md:flex flex-row items-center text-lg font-medium space-x-8 z-10'>
            
          <a href='#'  className='group relative inline-block cursor-pointer hover:text-brightcolor'>
            Home
            <span className='absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 origin-left transition-transform group-hover:scale-x-100'></span>
          </a>
          <a href='#services' to="/services" className='group relative inline-block cursor-pointer hover:text-brightcolor'>
            Our Services
            <span className='absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 origin-left transition-transform group-hover:scale-x-100'></span>
          </a>
          <a href='#about' className='group relative inline-block cursor-pointer hover:text-brightcolor'>
            About Us
            <span className='absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 origin-left transition-transform group-hover:scale-x-100'></span>
          </a>
          <a href='#contact'  className='group relative inline-block cursor-pointer hover:text-brightcolor'>
            Contact Us
            <span className='absolute inset-x-0 bottom-0 h-0.5 bg-black transform scale-x-0 origin-left transition-transform group-hover:scale-x-100'></span>
          </a>
        </nav>
